...
func (c *userServiceClient) List(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*UserList, error) {
	out := new(UserList)
...
func (UnimplementedUserServiceServer) List(context.Context, *empty.Empty) (*UserList, error) {
