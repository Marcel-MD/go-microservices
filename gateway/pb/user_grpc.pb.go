...
func (c *userServiceClient) Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*UserId, error) {
	out := new(UserId)
...
func (c *userServiceClient) GetAll(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*Users, error) {
	out := new(Users)
...
type UserServiceServer interface {
	Register(context.Context, *RegisterRequest) (*UserId, error)
...
func (UnimplementedUserServiceServer) Register(context.Context, *RegisterRequest) (*UserId, error) {
...
func (UnimplementedUserServiceServer) GetAll(context.Context, *emptypb.Empty) (*Users, error) {
